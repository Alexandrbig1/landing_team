...
Welcome to the Seventh Sense project repository! Here, you will find a collection of our collaborative efforts to create cutting-edge software solutions. Our current project, "Foodies", is a recipe website that allows users to explore a vast array of food recipes, create and share their own recipes, and engage with a community of food enthusiasts.
...
- **User Profiles**: Create your own profile to personalize your experience.
- **Recipe Database**: Search and browse a wide variety of recipes from different cuisines.
- **Create & Share Recipes**: Add your own recipes and share them with the community.
- **Followers**: Follow other users to stay updated with their latest recipes.
- **Favorites**: Save your favorite recipes for quick access later.
- **Interactive UI**: Enjoy a user-friendly interface designed for ease of use.
...
[open an issue](https://github.com/Alexandrbig1/landing_team/issues).
